...
define([
  ...
  return View.extend({
    ...
    reposition: function()
    {
      ...
      {
        var top = this.fieldEl.getBoundingClientRect().top;

        if (top + vkbH + 30 > window.innerHeight)
        {
          top -= (top + vkbH + 30) - window.innerHeight;
        }
